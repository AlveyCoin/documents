...
To accomplish this task, the alveychain leverages the battle-tested **libp2p** framework.
...
On top of **libp2p**, the alveychain uses the **GRPC** protocol. <br />
Technically, the alveychain uses several GRPC protocols, which will be covered later on.
...
Earlier, we mentioned that the alveychain leverages several GRPC protocols.<br />
...
The alveychain also implements several service methods that are used by other nodes on the network. <br />
