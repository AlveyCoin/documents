...
This enables the alveychain to get a specific Merkle trie, for a specific point in time. <br />
...
*state/executor.go* includes all the information needed for the alveychain to decide how a block changes the current
