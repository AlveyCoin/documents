...
As mentioned before, Alveychain is a set of different modules, all connected to each other.<br />
...
It acts as a central hub for all the services that run on the alveychain.
